...
set( CROSS_COMPILE ${CONFIG_CROSS_COMPILE_KERNEL} )
...
if ("${CROSS_COMPILE}" STREQUAL "arm-linux-gnueabihf-")
...
elseif ("${CROSS_COMPILE}" STREQUAL "arm-none-linux-musleabihf-")
  set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=armv7-a -mfpu=neon" )
  set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mfloat-abi=hard -marm" )
  set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=armv7-a -mfpu=neon" )
  set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mfloat-abi=hard -marm" )
  set( CMAKE_SYSROOT $ENV{TOP_DIR}/host-tools/gcc/arm-gnu-toolchain-11.3.rel1-x86_64-arm-none-linux-musleabihf/arm-none-linux-musleabihf/sysroot)
  set( CMAKE_C_FLAGS   "${CMAKE_C_FLAGS}   -DARM_MUSL" )
  set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DARM_MUSL" )
elseif("${CROSS_COMPILE}" STREQUAL "aarch64-linux-gnu-")
...
elseif("${CROSS_COMPILE}" STREQUAL "riscv64-unknown-linux-gnu-")
...
elseif("${CROSS_COMPILE}" STREQUAL "riscv64-unknown-linux-musl-")
