...
#include "sc231hai_cmos_param.h"

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define SC231HAI_ID 35
#define SENSOR_SC231HAI_WIDTH 640
#define SENSOR_SC231HAI_HEIGHT 480
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastSC231HAI[VI_MAX_PIPE_NUM] = {CVI_NULL};

ISP_SNS_MIRRORFLIP_TYPE_E g_pastSC231HAI_MirrorFip[VI_MAX_PIPE_NUM] = {0};

#define SC231HAI_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastSC231HAI[dev])
#define SC231HAI_SENSOR_SET_CTX(dev, pstCtx)   (g_pastSC231HAI[dev] = pstCtx)
#define SC231HAI_SENSOR_RESET_CTX(dev)         (g_pastSC231HAI[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunSC231HAI_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16SC231HAI_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16SC231HAI_L2SMode[VI_MAX_PIPE_NUM] = {0};

SC231HAI_STATE_S g_astSC231HAI_State[VI_MAX_PIPE_NUM] = {{0} };
...
/*****SC231HAI Lines Range*****/
#define SC231HAI_FULL_LINES_MAX  (0x7FFF)
#define SC231HAI_FULL_LINES_MAX_2TO1_WDR  (0x7FFF)

/*****SC231HAI Register Address*****/
#define SC231HAI_SHS1_0_ADDR		0x3E00
#define SC231HAI_SHS1_1_ADDR		0x3E01
#define SC231HAI_SHS1_2_ADDR		0x3E02
#define SC231HAI_SHS2_0_ADDR		0x3E22
#define SC231HAI_SHS2_1_ADDR		0x3E04
#define SC231HAI_SHS2_2_ADDR		0x3E05
#define SC231HAI_AGAIN1_ADDR		0x3E08
#define SC231HAI_DGAIN1_ADDR		0x3E06
#define SC231HAI_AGAIN2_ADDR		0x3E12
#define SC231HAI_DGAIN2_ADDR		0x3E10
#define SC231HAI_VMAX_ADDR		0x320E
#define SC231HAI_MAXSEXP_ADDR		0x3E23
#define SC231HAI_TABLE_END		0xFFFF
#define SC231HAI_FLIP_MIRROR_ADDR		0x3221

#define SC231HAI_RES_IS_480P(w, h)      ((w) <= 640 && (h) <= 480)
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	SC231HAI_SENSOR_GET_CTX(ViPipe, pstSnsState);
	...
	pstAeSnsDft->u32FullLinesMax = SC231HAI_FULL_LINES_MAX;
	...
	case WDR_MODE_NONE:   /*linear mode*/
		pstAeSnsDft->f32Fps = g_astSC231HAI_mode[pstSnsState->u8ImgMode].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astSC231HAI_mode[pstSnsState->u8ImgMode].f32MinFps;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Vts = g_astSC231HAI_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astSC231HAI_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astSC231HAI_mode[pstSnsState->u8ImgMode].f32MinFps;
	u16MaxSexpReg = g_astSC231HAI_mode[pstSnsState->u8ImgMode].u16SexpMaxReg;

	switch (pstSnsState->u8ImgMode) {
	case SC231HAI_MODE_480P60_WDR:
		...
		u32VMAX = (u32VMAX > SC231HAI_FULL_LINES_MAX_2TO1_WDR) ? SC231HAI_FULL_LINES_MAX_2TO1_WDR : u32VMAX;
		break;

	case SC231HAI_MODE_480P60:
	case SC231HAI_MODE_1080P60:
		if ((f32Fps <= f32MaxFps) && (f32Fps >= f32MinFps)) {
			u32VMAX = u32Vts * f32MaxFps / DIV_0_TO_1_FLOAT(f32Fps);
		} else {
			CVI_TRACE_SNS(CVI_DBG_ERR, "Not support Fps: %f\n", f32Fps);
		...
		u32VMAX = (u32VMAX > SC231HAI_FULL_LINES_MAX) ? SC231HAI_FULL_LINES_MAX : u32VMAX;
		break;
	default:
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		g_astSC231HAI_State[ViPipe].u32Sexp_MAX = u16MaxSexpReg - 11;
	}
...
static CVI_S32 cmos_inttime_update(VI_PIPE ViPipe, CVI_U32 *u32IntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		 ...
		 * min : 1
		 * max : 2 * reg_sexp_max - 19
		 * step : 4
		 */
		pstSnsState->au32WDRIntTime[0] = (u32ShortIntTime > g_astSC231HAI_State[ViPipe].u32Sexp_MAX) ?
			g_astSC231HAI_State[ViPipe].u32Sexp_MAX : u32ShortIntTime;
		if (!pstSnsState->au32WDRIntTime[0])
			pstSnsState->au32WDRIntTime[0] = 1;
		/* short exp = SexpReg / 2 */
		u16SexpReg = (CVI_U16)(pstSnsState->au32WDRIntTime[0] * 2 );
		 ...
		 * step : 4
		 */
		u32MaxLExp = pstSnsState->au32FL[0] - g_astSC231HAI_State[ViPipe].u32Sexp_MAX;
		...
		u16LexpReg = (CVI_U16)(pstSnsState->au32WDRIntTime[1] * 2 );
...
static CVI_U32 Again_table[] = {
    ...
    3265, 3328, 3393, 3456, 3521, 3584, 3649, 3712, 3777, 3789, 3908, 4025, 4144, 4263, 4381, 4499, 4617,
    4736, 4855, 4973, 5091, 5210, 5328, 5447, 5564, 5683, 5802, 5920, 6039, 6157, 6275, 6394, 6512, 6630,
    6749, 6867, 6986, 7105, 7222, 7341, 7459, 7578, 7814, 8052, 8288, 8525, 8761, 8999, 9235, 9472, 9709,
    9946, 10183, 10419, 10656, 10893, 11130, 11366, 11603, 11841, 12077, 12314, 12550, 12788, 13024, 13261,
    13497, 13735, 13971, 14208, 14445, 14682, 14919, 15155, 15629, 16102, 16577, 17050, 17524, 17997, 18471,
    18944, 19418, 19891, 20365, 20838, 21313, 21786, 22260, 22733, 23207, 23680, 24154, 24627, 25101, 25574,
    26049, 26522, 26996, 27469, 27943, 28416, 28890, 29363, 29837, 30310, 31258, 32205, 33152, 34099, 35046,
    35994, 36941, 37888, 38835, 39782, 40730, 41677, 42624, 43571, 44518, 45466, 46413, 47360, 48307, 49254,
    50202, 51149, 52096, 53043, 53990, 54938, 55885, 56832, 57779, 58726, 59674, 60621, 62515, 64410, 66304,
    68198, 70093, 71987, 73882, 75776, 77670, 79565, 81459, 83354, 85248, 87142, 89037, 90931, 92826, 94720,
    96614, 98509, 100403, 102298, 104192, 106086, 107981, 109875, 111770, 113664, 115558, 117453, 119347
};
...
static CVI_U32 Dgain_table[] = {
	...
	31232, 31488, 31744, 32000, 32256, 32512, 33280, 34048, 34816, 35584, 36352, 37120, 37888,
	38656, 39424, 40192, 40960
};
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
	CVI_U32 u16Mode = g_au16SC231HAI_GainMode[ViPipe];
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	u32IntTimeMaxTmp = (u32IntTimeMaxTmp > (g_astSC231HAI_State[ViPipe].u32Sexp_MAX * 2)) ?
				(g_astSC231HAI_State[ViPipe].u32Sexp_MAX * 2) : u32IntTimeMaxTmp;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const SC231HAI_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	SC231HAI_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astSC231HAI_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		if (pstSnsState->u8ImgMode == SC231HAI_MODE_480P60_WDR)
			pstSnsState->u8ImgMode = SC231HAI_MODE_480P60;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astSC231HAI_mode[pstSnsState->u8ImgMode].u32VtsDef;
		syslog(LOG_INFO, "linear mode\n");
		break;

	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == SC231HAI_MODE_480P60)
			pstSnsState->u8ImgMode = SC231HAI_MODE_480P60_WDR;
		pstSnsState->enWDRMode = WDR_MODE_2To1_LINE;
		pstSnsState->u32FLStd = g_astSC231HAI_mode[pstSnsState->u8ImgMode].u32VtsDef;
		syslog(LOG_INFO, "2to1 line WDR 480p mode(60fps->30fps)\n");
		break;
	default:
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunSC231HAI_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = sc231hai_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = sc231hai_addr_byte;
			pstI2c_data[i].u32DataByteNum = sc231hai_data_byte;
		}
		...
		case WDR_MODE_2To1_LINE:
			//WDR Mode Regs
			pstI2c_data[WDR2_SHS1_0_ADDR].u32RegAddr = SC231HAI_SHS1_0_ADDR;
			pstI2c_data[WDR2_SHS1_1_ADDR].u32RegAddr = SC231HAI_SHS1_1_ADDR;
			pstI2c_data[WDR2_SHS1_2_ADDR].u32RegAddr = SC231HAI_SHS1_2_ADDR;
			pstI2c_data[WDR2_SHS2_0_ADDR].u32RegAddr = SC231HAI_SHS2_0_ADDR;
			pstI2c_data[WDR2_SHS2_1_ADDR].u32RegAddr = SC231HAI_SHS2_1_ADDR;
			pstI2c_data[WDR2_SHS2_2_ADDR].u32RegAddr = SC231HAI_SHS2_2_ADDR;
			pstI2c_data[WDR2_AGAIN1_0_ADDR].u32RegAddr = SC231HAI_AGAIN1_ADDR;
			pstI2c_data[WDR2_AGAIN1_1_ADDR].u32RegAddr = SC231HAI_AGAIN1_ADDR + 1;
			pstI2c_data[WDR2_DGAIN1_0_ADDR].u32RegAddr = SC231HAI_DGAIN1_ADDR;
			pstI2c_data[WDR2_DGAIN1_1_ADDR].u32RegAddr = SC231HAI_DGAIN1_ADDR + 1;
			pstI2c_data[WDR2_AGAIN2_0_ADDR].u32RegAddr = SC231HAI_AGAIN2_ADDR;
			pstI2c_data[WDR2_AGAIN2_1_ADDR].u32RegAddr = SC231HAI_AGAIN2_ADDR + 1;
			pstI2c_data[WDR2_DGAIN2_0_ADDR].u32RegAddr = SC231HAI_DGAIN2_ADDR;
			pstI2c_data[WDR2_DGAIN2_1_ADDR].u32RegAddr = SC231HAI_DGAIN2_ADDR + 1;
			pstI2c_data[WDR2_VMAX_0_ADDR].u32RegAddr = SC231HAI_VMAX_ADDR;
			pstI2c_data[WDR2_VMAX_1_ADDR].u32RegAddr = SC231HAI_VMAX_ADDR + 1;
			pstI2c_data[WDR2_MAXSEXP_0_ADDR].u32RegAddr = SC231HAI_MAXSEXP_ADDR;
			pstI2c_data[WDR2_MAXSEXP_1_ADDR].u32RegAddr = SC231HAI_MAXSEXP_ADDR + 1;
			pstI2c_data[WDR2_FLIP_MIRROR].u32RegAddr = SC231HAI_FLIP_MIRROR_ADDR;

			break;
		default:
			//Linear Mode Regs
			pstI2c_data[LINEAR_SHS1_0_ADDR].u32RegAddr = SC231HAI_SHS1_0_ADDR;
			pstI2c_data[LINEAR_SHS1_1_ADDR].u32RegAddr = SC231HAI_SHS1_1_ADDR;
			pstI2c_data[LINEAR_SHS1_2_ADDR].u32RegAddr = SC231HAI_SHS1_2_ADDR;
			pstI2c_data[LINEAR_AGAIN_0_ADDR].u32RegAddr = SC231HAI_AGAIN1_ADDR;
			pstI2c_data[LINEAR_AGAIN_1_ADDR].u32RegAddr = SC231HAI_AGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_DGAIN_0_ADDR].u32RegAddr = SC231HAI_DGAIN1_ADDR;
			pstI2c_data[LINEAR_DGAIN_1_ADDR].u32RegAddr = SC231HAI_DGAIN1_ADDR + 1;
			pstI2c_data[LINEAR_VMAX_0_ADDR].u32RegAddr = SC231HAI_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_1_ADDR].u32RegAddr = SC231HAI_VMAX_ADDR + 1;
			pstI2c_data[LINEAR_FLIP_MIRROR].u32RegAddr = SC231HAI_FLIP_MIRROR_ADDR;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 60) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (SC231HAI_RES_IS_480P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC231HAI_MODE_480P60;
			} else if (SC231HAI_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC231HAI_MODE_1080P60;
			} else {
			...
			if (SC231HAI_RES_IS_480P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = SC231HAI_MODE_480P60_WDR;
			} else {
				CVI_TRACE_SNS(CVI_DBG_ERR, "Not support! Width:%d, Height:%d, Fps:%f, WDRMode:%d\n",
				       pstSensorImageMode->u16Width,
				       pstSensorImageMode->u16Height,
 ...
 CVI_VOID sc231hai_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	CVI_U8 val = 0x0;
	CVI_U8 start_x = 0;
	CVI_U8 start_y = 0;
	...
	if (pstSnsState->bInit == CVI_TRUE && g_pastSC231HAI_MirrorFip[ViPipe] != eSnsMirrorFlip) {
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &sc231hai_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astSC231HAI_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astSC231HAI_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &sc231hai_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = sc231hai_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = sc231hai_exit;
...
static CVI_S32 sc231hai_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunSC231HAI_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	SC231HAI_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
	...
	SC231HAI_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	SC231HAI_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = SC231HAI_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, SC231HAI_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, SC231HAI_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, SC231HAI_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16SC231HAI_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16SC231HAI_L2SMode[ViPipe] = pstInitAttr->enL2SMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsSC231HAI_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = sc231hai_standby,
	.pfnRestart             = sc231hai_restart,
	.pfnMirrorFlip          = sc231hai_mirror_flip,
	.pfnWriteReg            = sc231hai_write_register,
	.pfnReadReg             = sc231hai_read_register,
	.pfnSetBusInfo          = sc231hai_set_bus_info,
