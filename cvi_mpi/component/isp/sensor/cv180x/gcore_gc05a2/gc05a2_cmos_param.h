#ifndef __GC05A2_CMOS_PARAM_H_
#define __GC05A2_CMOS_PARAM_H_
...
static const GC05A2_MODE_S g_astGc05a2_mode[GC05A2_MODE_NUM] = {
	[GC05A2_MODE_720P60] = {
	.name = "720P60",
		.astImg[0] = {
			.stSnsSize = {
		...
		.f32MaxFps = 60,
		.f32MinFps = 0.01, /* 1500 * 30 / 16383  */
		.u32HtsDef = 3616,
		.u32VtsDef = 1032, /* 0x0340 0x0341 0x408*/
		.stExp[0] = {
			.u16Min = 1,
			.u16Max = 1032,
			.u16Def = 1024,
...
static ISP_CMOS_BLACK_LEVEL_S g_stIspBlcCalibratio = {
	...
	.blcAttr = {
		...
		.stAuto = {
			{252, 256, 256, 257, 260, 264, 272, 289, 324, 400, 468, 474, 475, 476, 466, 496 },
			{252, 256, 256, 257, 260, 264, 272, 289, 325, 404, 469, 476, 477, 477, 467, 493 },
			{252, 256, 256, 257, 260, 264, 272, 289, 325, 401, 468, 477, 476, 477, 467, 495 },
			{252, 256, 256, 257, 260, 264, 272, 290, 325, 404, 471, 477, 478, 478, 468, 493 },
...
struct combo_dev_attr_s gc05a2_rx_attr = {
