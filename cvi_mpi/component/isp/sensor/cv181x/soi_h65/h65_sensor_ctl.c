...
static void h65_linear_720p30_init(VI_PIPE ViPipe)
{
	...
	h65_write_register(ViPipe, 0x60, 0x10);
	...
	h65_write_register(ViPipe, 0x27, 0x6D);
	h65_write_register(ViPipe, 0x28, 0x14);
	h65_write_register(ViPipe, 0x29, 0x01);
	h65_write_register(ViPipe, 0x2A, 0x59);
	h65_write_register(ViPipe, 0x2B, 0x25);
	h65_write_register(ViPipe, 0x2C, 0x00);
	h65_write_register(ViPipe, 0x2D, 0x20);
	h65_write_register(ViPipe, 0x2E, 0xD9);
	...
	h65_write_register(ViPipe, 0x73, 0x53);
